# Paper Scout Metadata Quality - 2026-09-24

- **Year-only publication dates:** 2
- **SSRN/DOI date enrichment warnings:** 3
- **SSRN/DOI papers still without exact dates:** 0
- **First-seen sort fallbacks:** 6
- **Low-confidence date fields:** 1
...
## SSRN/DOI Papers Still Without Exact Dates
...
- **Benchmarking Agent Memory in Interdependent Multi-Session Agentic Tasks** — maybe, unknown, precision=unknown, source=semantic_scholar
...
- **Consolidation Without Weights: What the Complementary Learning Systems Analogy Licenses in LLM Agent Memory, and Why the Systems That Borrow Its Name Do Not Inherit Its Guarantee** — relevant, 2026-09-11, precision=day, source=openalex
- **ZenBrain: Neuroscience-Inspired Agent Memory Library for LLM Agents** — relevant, 2026-09-02, precision=day, source=openalex

## Highly Relevant With Generic Reasons
...
## High-Scoring Agentic-AI Papers Without Explicit Memory Evidence
...
- **An Interpretable Memory Decision Controller for LLM Agents Based on Three-Signal Complementarity: Decoupling Confidence and Consistency** — maybe, 2026-09-18, precision=day, source=openalex
- **fidelis: zero-LLM agent memory for Claude Code and AI agents** — maybe, 2026-09-13, precision=day, source=openalex
- **BIO-MEMART: Biometric-Aware KV Cache Memory for Multi-User LLM Agents** — maybe, 2026-09-08, precision=day, source=openalex
- **MEMO: Multimodal Evidence Memory Organization for Long-Horizon LLM Agents** — maybe, 2026-09-07, precision=day, source=openalex
- **darwin-memo: self-curating memory for LLM agents** — maybe, 2026-09-04, precision=day, source=openalex
- **Agent Memory Is a Surface for Endogenous Authorization Laundering** — maybe, 2026-09-01, precision=day, source=openalex
- **Recognition Without Enforcement: Configuration-Dependent Failures in LLM Agent Instruction Arbitration and External Control** — maybe, 2026-08-28, precision=day, source=arxiv
- **MemGuard: Persisting Verifier Signals for LLM-Agent Memory Governance** — maybe, 2026-08-22, precision=day, source=openalex
- **Retrieval Beats Cheap Structured Memory: A Cost–Retention Study of LLM Agent Memory on Real Long-Conversation Benchmarks** — maybe, 2026-08-20, precision=day, source=openalex
- **PsychoAgent: An Affect-Sensitive Cognitive Architecture for Conflict-Aware Memory in LLM Agents** — maybe, 2026-08-07, precision=day, source=openalex
...
- **MemPoison: Uncovering Persistent Memory Threats and Structural Blind Spots in LLM Agents** — maybe, 2026-07-16, precision=day, source=openalex
- **PM-Bench: Evaluating Prospective Memory in LLM Agents** — maybe, 2026-07-14, precision=day, source=openalex
- **Plausibly wrong: peer-voted retention can fall below random in capped shared memory for LLM agents** — maybe, 2026-07-05, precision=day, source=openalex
