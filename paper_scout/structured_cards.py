...
def paper_card_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "properties": {
            ...
            "publication_status": {"enum": ["peer_reviewed", "preprint", "repository_only", "unknown"]},
            "publication_status_evidence": {"type": "string"},
            "library_admission": {"enum": ["main", "review", "not_surfaced"]},
            ...
            "scholarly_quality": {
                ...
                "properties": {
                    "status": {"enum": ["pass", "uncertain", "insufficient", "not_assessed"]},
