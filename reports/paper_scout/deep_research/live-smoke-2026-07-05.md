...
- semantic_scholar (HTTP/API error) for `deep research agents`: Semantic Scholar returned HTTP 429 despite an API key, likely because query volume was high. The run continued with other sources.
