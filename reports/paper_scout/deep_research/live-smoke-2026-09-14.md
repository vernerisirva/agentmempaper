...
- Raw records: 0
- Converted candidates: 0
- Error: HTTP/API error: http error for https://api.openalex.org/works?search=deep+research+agent&filter=from_publication_date%3A2026-08-31&per-page=25: request failed after 3 attempts: HTTP Error 429: Too Many Requests
...
- openalex (HTTP/API error) for `deep research agent`: http error for https://api.openalex.org/works?search=deep+research+agent&filter=from_publication_date%3A2026-08-31&per-page=25: request failed after 3 attempts: HTTP Error 429: Too Many Requests
