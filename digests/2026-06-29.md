...
- **Maybe relevant:** 152
- **Irrelevant:** 344
- **Source summary:** arxiv: 27, openalex: 833, semantic_scholar: 20
...
### [MemForge: Portable, agent-neutral persistent memory format for AI coding agents (v0.9.0)](https://doi.org/10.5281/zenodo.20999236)
...
- **Abstract summary:** MemForge v0.9.0: portable, agent-neutral persistent memory format for coding agents. This deposit anchors the v0.9.0 ship state (reference-CLI package 0.9.0; spec snapshot spec/VERSION 0.7.0). The bundle ships the spec snapshot plus the full reference-CLI artifacts (CHANGELOG, README, license, examples/). What v0.9....

### [Continuity and Emergence in LLM-Based Digital Entities: Observed Behavioral Outcomes of Persistent Memory and Autonomous Operation](https://doi.org/10.5281/zenodo.20992605)

- **Authors:** Panagiotis Korfoxyliotis, Business Solutions EOOD, Wolf holdings LLC
- **Date:** 2026-06-28
- **Source:** openalex
- **Relevance:** relevant (100/100)
- **Reason:** Focuses on persistent or long-term memory for agent behavior.
...
### [Continuity and Emergence in LLM-Based Digital Entities: Observed Behavioral Outcomes of Persistent Memory and Autonomous Operation](https://doi.org/10.5281/zenodo.20992604)
...
### [MemForge: Portable, agent-neutral persistent memory format for AI coding agents (v0.8.1)](https://doi.org/10.5281/zenodo.20995032)
...
- **Abstract summary:** MemForge v0.8.1: portable, agent-neutral persistent memory format for coding agents. This deposit anchors the v0.8.1 ship state (reference-CLI package 0.8.1; spec snapshot spec/VERSION 0.6.3). The bundle ships the spec snapshot plus the full reference-CLI artifacts (CHANGELOG, README, license, examples/). What v0.8....

### [Knowledge Classification Protocol (KCP): An Ontological Architecture for Persistent Memory, Multimodal Perception, and Metacognition in LLM Agents](https://doi.org/10.5281/zenodo.20999815)
...
### [Designing the AI-Native Operating System: An Architecture for Orchestrated Multi-Model Inference at the Edge](https://doi.org/10.5281/zenodo.21008312)
...
- **Tags:** untagged
- **Abstract summary:** The classical operating system abstraction—built around deterministic instruction execution and thread scheduling—poorly fits modern foundation models, whose workloads are probabilistic, parameter-heavy, and memory-bandwidth-bound. This paper proposes a fundamentally reimagined AI-native operating system whose primi...

### [Designing the AI-Native Operating System: An Architecture for Orchestrated Multi-Model Inference at the Edge](https://doi.org/10.5281/zenodo.21008313)
...
- **Authors:** Zhewei Xu, Dongsheng Chen, Jian Li, Ye Lin, Zhebo Wang, Jianmin Wu, et al.
- **Date:** 2026-06-25
- **Source:** openalex
- **Relevance:** maybe (45/100)
- **Reason:** Peripheral candidate: discusses agentic AI system architecture, but does not clearly study persistent agent memory.
- **Tags:** untagged
- **Abstract summary:** Building general-purpose role-playing agents that faithfully portray any character from a natural-language profile remains challenging. The dominant paradigm -- supervised fine-tuning -- encourages behavioral mimicry without deep, human-like internal thought processes, resulting in poor out-of-distribution generaliz...

### [CHIA: An open-source framework for principled, agentic AI-driven hardware/software co-design research](https://arxiv.org/abs/2606.27350)

- **Authors:** Angela Cui, Ferran Hermida-Rivera, Jack Toubes, Raghav Gupta, Jim Fang, Chengyi Lux Zhang, et al.
- **Date:** 2026-06-25
- **Source:** openalex
- **Relevance:** maybe (45/100)
- **Reason:** Peripheral candidate: discusses agentic AI system architecture, but does not clearly study persistent agent memory.
- **Tags:** untagged
- **Abstract summary:** Agentic artificial intelligence shows great promise for radically improving the pace of innovation in hardware/software co-design research across computer architecture, systems, compilers, and VLSI. Thus far, however, applications of AI in these contexts have generally been demonstrated in isolated settings on small...
...
- **Reason:** Peripheral candidate: discusses agentic AI system architecture, but does not clearly study persistent agent memory.
- **Tags:** untagged
- **Abstract summary:** Large language models (LLMs) are increasingly deployed in interactive applications, yet they remain vulnerable to adversarial interactions that induce harmful, deceptive, or policy-violating outputs. Existing defenses typically analyze either user prompts or generated outputs, but not both. However, many real-world...

### [Knowledge-augmented Agentic AI for Mental Health Medication Information Seeking](https://arxiv.org/abs/2606.26205)

- **Authors:** Huizi Yu, Jian Liu, W. Wang, Lingyao Li, Jiayan Zhou, Zhaoqian Xue, et al.
- **Date:** 2026-06-24
- **Source:** openalex
- **Relevance:** maybe (45/100)
- **Reason:** Peripheral candidate: discusses agentic AI system architecture, but does not clearly study persistent agent memory.
- **Tags:** untagged
- **Abstract summary:** Patients increasingly seek medication information online, yet safety knowledge for psychiatric drugs is split between regulatory adverse-event records, which are authoritative but abstract, and patient narratives, which are experience-near but unvalidated. Integrating them without conflating evidence and anecdote is...
