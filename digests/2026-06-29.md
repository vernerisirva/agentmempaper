...
- **Run ID:** 30
- **Candidates fetched:** 873
- **New unique papers:** 260
- **Relevant:** 376
- **Maybe relevant:** 160
- **Irrelevant:** 337
- **Source summary:** arxiv: 29, openalex: 831, semantic_scholar: 13
...
- semantic_scholar failed for 'memory retrieval policy agent': Semantic Scholar returned HTTP 429 despite an API key, likely because query volume was high. The run continued with other sources.
...
### [TRUSTMEM: Learning Trustworthy Memory Consolidation for LLM Agents with Long-Term Memory](https://www.semanticscholar.org/paper/1d3d2f04270110888af84b9222c8a6a41a791b54)
...
- **Tags:** llm-agents, long-term-memory, memory-policy, evaluation, agent-memory, memory-systems
...
### [DMV-Bench: Diagnosing Long-Horizon Multimodal Agents' Visual Memory with Incidental Cue Injection](https://arxiv.org/abs/2606.27499v1)
